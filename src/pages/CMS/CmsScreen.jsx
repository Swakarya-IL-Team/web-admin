...
const CmsScreen = () => {
    ...
    const [museumInformation, setMuseumInformation] = useState([]);

    useEffect(() => {
        fetchMuseumInformation();
    }, []);

    const fetchMuseumInformation = async() => {
        try {
  ...
  return (
    <>
        <div className="flex flex-col h-screen">
            ...
            <div className="flex">
                <Sidebar />
                <div className="flex flex-col flex-1 overflow-x-hidden px-10 space-y-5 bg-[#F8F8F8]">
