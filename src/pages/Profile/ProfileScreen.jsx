        ...
        <>
            <div className="flex flex-col h-screen">
                ...
                <div className="flex flex-1">
                    <Sidebar />
                    <div className="flex flex-col flex-1 px-10 space-y-5 bg-[#F8F8F8] ml-[290px] pb-12">
                        ...
                        <div className="rounded-[8px] border border-[#728969] bg-white px-8 py-10 mb-10">
                            <div className="flex flex-row justify-between items-center">
                                <h1 className="text-[#728969] text-[24px] font-bold ">Personal Information</h1>
